...
def get_api_key(config_key: str = "volcengine_api_key", config_filename: str = "config.json") -> str:
    """
    Get API key from configuration file.
    
    :param config_key: Key name for the API key in config (default: "volcengine_api_key")
    :param config_filename: Name of the configuration file (default: "config.json")
